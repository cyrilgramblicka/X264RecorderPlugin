...
//@file  javascript interface dispatcher generated by intergen v4
...
public:
    ...
    static v8::Handle<v8::Value> v8rebind_events( const v8::Arguments& args );
    ...
    virtual bool is_implemented_boo() override { return is_event_bound(0); }
    ...
    virtual void force_bind_script_events() {
        ...
        bind_events(_context, true, v8::Undefined());
    }
...
private:
    bool is_event_bound( int id )
    {
        if(!_bound_events) {
            ...
            bind_events(_context, false, v8::Undefined());
        }
...
v8::Handle<v8::Value> thingface_js_dispatcher::v8_hallo0(const v8::Arguments& args)
{
    if(args.Length() < 2 || args.Length() > 2)  //in/inout arguments
        return v8::ThrowException(v8::Exception::SyntaxError(v8::String::New("Wrong number of arguments")));
    ...
    if(!R_)
        return v8::ThrowException(v8::Exception::ReferenceError(v8::String::New("null interface object in thingface.hallo()")));
    ...
    return _handle_scope_.Close(_r_);
        ...
        ifc->_meta.stream_reset(true, false);
        return v8::ThrowException(v8::Exception::TypeError(v8::String::New(e.text().ptr(), e.text().len())));
    }
}
...
v8::Handle<v8::Value> thingface_js_dispatcher::v8_fallo1(const v8::Arguments& args)
{
    ...
    auto R_ = ifc ? ifc->_real() : 0;
    if(!R_)
        return v8::ThrowException(v8::Exception::ReferenceError(v8::String::New("null interface object in thingface.fallo()")));
...
void thingface_js_dispatcher::boo( const char* key )
{
    ...
    v8::Local<v8::Value> _r_ = _events[0]->Call(_eventobj.IsEmpty() || _eventobj->IsUndefined() ? _object : _eventobj, 1, __inargs);
...
v8::Handle<v8::Value> thingface_js_dispatcher::v8query_interface(const v8::Arguments& args)
{
    ...
    if(!get) {
        ...
        tmp << tokey << " not found";
        return v8::ThrowException(v8::String::New(tmp.c_str()));
    }
    ...
    if(!ifc)
        return v8::ThrowException(v8::Exception::ReferenceError(v8::String::New("null interface object in $query_interface")));

    return _handle_scope_.Close(get(args, ifc));
}

////////////////////////////////////////////////////////////////////////////////
v8::Handle<v8::Value> thingface_js_dispatcher::v8rebind_events(const v8::Arguments& args)
{
    v8::HandleScope _handle_scope_;
    v8::Local<v8::Object> _obj_ = args.Holder();
    ...
    if(ifc) {
        ...
        if(args.Length() > 0)
            val = args[0];
        ifc->bind_events(ifc->_context, true, val);
    }
...
v8::Handle<v8::Object> thingface_js_dispatcher::create_interface_object( bool make_weak )
{
    ...
    if(_objtempl.IsEmpty())
    {
        ...
        _objtempl->Set(v8::String::NewSymbol("$rebind_events"), v8::FunctionTemplate::New(&v8rebind_events));
    }
    ...
    v8::Handle<v8::External> hash_ptr = v8::External::New((void*)324072501);
...
void thingface_js_dispatcher::bind_events( v8::Handle<v8::Context> context, bool force, v8::Handle<v8::Value> ref )
{
    ...
    if(ref.IsEmpty() || ref->IsUndefined()) {
        ...
        global = ref->ToObject();
        _eventobj = v8::Persistent<v8::Object>::New(global);
    }
    ...
    for(int i=0; i<1; ++i)
    {
        ...
        bool failed = __trycatch.HasCaught() || foo->IsUndefined();
...
v8::Handle<v8::Value> thingface_js_dispatcher::v8creator_get0(const v8::Arguments& args, interface_context* ifc)
{
    ...
    //stream out
    v8::Handle<v8::Value> Null = v8::Null();
    v8::Handle<v8::Value> _r_ = !nifc ? Null : nifc->create_interface_object(true);
...
void* register_binders_for_thingface()
{
    ...
    interface_register::register_interface_creator(
        "ifc1::ifc2::js::thingface@wrapper", (void*)&create_wrapper_thingface);
