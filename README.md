...
You must compile the static libraries on your own and then link to the VS project. 
...
comm source code is in "source\api\comm" directory. Soulution file path: "source\api\comm\_build\msvc\2013\comm.sln". Just compile comm_static project.
